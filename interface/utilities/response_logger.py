...
predefined_prompts = {
    ...
    "report_format": ("you write clear, concise and well-researched reports by synthesizing "
                      "the following information into the report format specified by this "
                      "JSON object: {\"report_title\":\"report title\", "
                      "\"report_executive_summary\":\"report executive summary\", "
                      "\"report_body\":\"report body\", \"report_references\":\"report references\"}: \n ")
}
...
class ResponseLog:
    ...
    version: str = "2506"
    ai: str = "grok-2-latest"
    agent: str = ""
    comments: str = "testing blog creator"
...
class ResponseLogger:
    ...
    def ai_to_bq(self,
        ...
        Args:
            prompt (str): Prefix prompt that will be a prefix to the content and form the LLM
                ...
                'report_format. If the prompt does not match one of the predefined keys,
                the passed prompt will be used.
    ...
    def response_to_bq(self,
        ...
        Args:
            rlog_params (Dict): Response log values in a dictionary with keys corresponding
                to response log fields.
        ...
        # check if dictionary
            ...
            msg = ("If the rlogs_param argument is present it must be a dictionary. "
                   "Please review.")
            raise ValueError
